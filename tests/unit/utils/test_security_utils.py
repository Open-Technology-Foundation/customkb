...
class TestValidateApiKey:
  ...
  def test_valid_api_keys(self):
    ...
    assert validate_api_key('sk-1234567890abcdef1234567890abcdef', prefix='sk-') is True
    assert validate_api_key('1234567890abcdef1234567890abcdef', prefix=None) is True
  
  def test_invalid_api_keys(self):
    """Test invalid API key formats."""
    assert validate_api_key('') is False
    assert validate_api_key('short') is False
    assert validate_api_key('sk-short', min_length=20) is False
    assert validate_api_key('wrong-prefix-1234567890abcdef1234', prefix='sk-') is False
    assert validate_api_key('key with spaces 1234567890') is False
    assert validate_api_key('key@with#special$chars%1234') is False
