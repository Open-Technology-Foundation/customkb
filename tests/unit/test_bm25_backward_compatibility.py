...
from database.db_manager import process_text_file
from database.migrations import migrate_for_bm25
...
""")
    ...
    try:
      ...
      from database.chunking import init_text_splitter
...
""")
    ...
    with contextlib.suppress(sqlite3.Error, DatabaseError):
      migrate_for_bm25(kb)
