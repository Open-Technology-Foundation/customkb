...
class TestMergeSearchResults:
  ...
  def test_merge_custom_weights(self):
    ...
    # Equal weights
    result1 = merge_search_results(vector_results, bm25_results, vector_weight=0.5, bm25_weight=0.5)

    # Favor vector
    result2 = merge_search_results(vector_results, bm25_results, vector_weight=0.9, bm25_weight=0.1)

    # Favor BM25
    result3 = merge_search_results(vector_results, bm25_results, vector_weight=0.1, bm25_weight=0.9)
  ...
  def test_merge_normalizes_weights(self):
    ...
    result = merge_search_results(vector_results, bm25_results, vector_weight=2.0, bm25_weight=3.0)
...
class TestEdgeCases:
  ...
  def test_merge_zero_weights(self):
    ...
    # Zero vector weight
    result1 = merge_search_results(vector_results, bm25_results, vector_weight=0.0, bm25_weight=1.0)

    # Zero BM25 weight
    result2 = merge_search_results(vector_results, bm25_results, vector_weight=1.0, bm25_weight=0.0)
...
class TestMergeSearchResultsFusionMethod:
  ...
  def test_merge_explicit_rrf(self):
    ...
    result = merge_search_results(vector_results, bm25_results, fusion_method='rrf')
  ...
  def test_merge_weighted_method(self):
    ...
    result = merge_search_results(vector_results, bm25_results, fusion_method='weighted')
