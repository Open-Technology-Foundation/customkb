...
class TestCategoryDeduplicator:
  ...
  def test_init_custom_values(self):
    ...
    dedup = CategoryDeduplicator(similarity_threshold=90.0, case_sensitive=True, ignore_words=custom_ignore)
  ...
  def test_find_duplicates_similar_categories(self):
    ...
    categories = ['Machine Learning', 'Machine learning', 'ML', 'Artificial Intelligence', 'AI']
  ...
  def test_find_duplicates_prefers_shorter_names(self):
    ...
    dedup = CategoryDeduplicator(similarity_threshold=85.0)
    categories = ['Machine Learning and Artificial Intelligence', 'Machine Learning']
  ...
  def test_merge_category_counts_with_groups(self):
    ...
    counts = {'AI': 10, 'Artificial Intelligence': 20, 'A.I.': 5, 'Physics': 3}
  ...
  def test_merge_category_counts_preserves_unmerged(self):
    ...
    group = CategoryMergeGroup(primary='ML', aliases={'Machine Learning'}, similarity_scores={'Machine Learning': 92.0})
    dedup.merge_groups = [group]

    counts = {'ML': 5, 'Machine Learning': 10, 'Physics': 8, 'Chemistry': 12}
  ...
  def test_apply_to_results_preserves_order(self):
    ...
    group = CategoryMergeGroup(primary='ML', aliases={'Machine Learning'}, similarity_scores={'Machine Learning': 90.0})
    dedup.merge_groups = [group]
  ...
  def test_suggest_manual_review_finds_near_duplicates(self):
    ...
    dedup = CategoryDeduplicator()
    categories = ['Machine Learning', 'Machine learning applications', 'Deep Learning']
  ...
  def test_suggest_manual_review_sorted_by_score(self):
    ...
    dedup = CategoryDeduplicator()
    categories = ['AI', 'Artificial Intelligence', 'A.I. Research', 'Machine Learning', 'ML Algorithms']
...
class TestCategoryMergeGroup:
  ...
  def test_category_merge_group_creation(self):
    ...
    group = CategoryMergeGroup(
      primary='AI', aliases={'Artificial Intelligence'}, similarity_scores={'Artificial Intelligence': 90.0}
    )
  ...
  def test_category_merge_group_empty_aliases(self):
    ...
    group = CategoryMergeGroup(primary='Physics', aliases=set(), similarity_scores={})
