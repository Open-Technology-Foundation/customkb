...
def main():
  parser = argparse.ArgumentParser(description='Upgrade existing CustomKB database with BM25 tokens')
  parser.add_argument('config', help='Knowledgebase configuration file or name')
  parser.add_argument(
    '--batch-size', type=int, default=1000, help='Number of documents to process in each batch (default: 1000)'
  )
